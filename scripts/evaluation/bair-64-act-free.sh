accelerate launch train_gpt.py \
    --exp_name bair-64-act-free-eval --output_dir log_eval --seed 0 --mixed_precision bf16 \
    --vqgan_type ctx_vqgan --config_name configs/llama/config.json \
    --pretrained_model_name_or_path pretrained_models/ivideogpt-bair-64-act-free/tokenizer \
    --pretrained_transformer_path pretrained_models/ivideogpt-bair-64-act-free/transformer \
