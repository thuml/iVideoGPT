...
accelerate launch train_tokenizer.py \
    ...
    --train_batch_size 2 --gradient_accumulation_steps 4 --disc_start 250000 \
...
accelerate launch train_gpt.py \
    --exp_name oxe-256-act-free-transformer --output_dir log_trm --seed 0 --mixed_precision bf16 \
