# Pre-training tokenizer using four A100-40GB GPUs (the same as oxe-64-act-free.sh)
# Arguments:
...
accelerate launch train_gpt.py \
    --exp_name oxe-64-act-free-medium-transformer --output_dir log_trm --seed 0 --mixed_precision bf16 \
    --vqgan_type ctx_vqgan \
    --pretrained_model_name_or_path {log directory of finetuned tokenizer}/unwrapped_model \
    --config_name configs/llama/config_medium.json \
    ...
    --weight_decay 0.01 --llama_attn_drop 0.1 --embed_no_wd --max_grad_norm 1.0